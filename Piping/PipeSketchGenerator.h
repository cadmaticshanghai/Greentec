...
#define	Tag_Drawing_OutSurfTreat     "~D5"                          /* 管子外表面处理 */
#define	Tag_Drawing_InSurfTreat      "~D6"                          /* 管子内表面处理 */
#define	Tag_Drawing_TestPress        "~D7"                          /* 试验压力 */
#define	Tag_Drawing_BendingRadiu     "~D8"                          /* 弯模半径 */
#define	Tag_Drawing_SpoolWeight      "~D9"                          /* 管段重量 */
#define	Tag_Drawing_SpoolName        "~DA"                          /* 管号 */
#define	Tag_Drawing_SpoolType        "~DB"                          /* 管段类型 */

/* 定义项目信息对应的TAG定义 */
#define Tag_Project_Description      ".dG"                          /* 项目描述 - 项目名称，系统默认属性 */
#define Tag_Project_Number           "Uf6"                          /* 项目编号 */
#define Tag_Project_ClassName        "cla"                          /* 船级社名称 */
...
/*零件表相关设置*/
global int Mto_Table_Orign_X = 25;
global int Mto_Table_Orign_Y = 286;
global int Mto_Table_W = 145;
global int Mto_Table_H = 4;
global int Mto_Table_Column1_W = 6;
global int Mto_Table_Column2_W = 20;
global int Mto_Table_Column3_W = 10;
global int Mto_Table_Column4_W = 89;
global int Mto_Table_Column5_W = 20;
...
global int Check_Table_Orign_Y = 286;
...
global int Bending_Table_Orign_Y = 41;
...
/*装配表相关设置*/
global int Assembly_Table_Orign_X = 25;
global int Assembly_Table_Orign_Y = 41;
...
/* 定义尺寸标注的最短距离(图纸上的距离) */
global  int     MinDimDistance = 1;
global  int     CheckMinDimDistance = 1;    /* 这个设置会导致法兰直接焊到异径是标注不正确 */
